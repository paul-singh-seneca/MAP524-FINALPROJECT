...
public class AboutFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        */
        ...
        fancyAboutPage.setName("Paul Singh");
        fancyAboutPage.setDescription("Android App Developer");
